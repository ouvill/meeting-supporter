...
def download_reazonspeech_snapshot(*, local_files_only: bool = False) -> str:
    """Resolve the fixed int8 model files in Hugging Face's shared cache."""
...
def load_reazonspeech_recognizer(snapshot_path: str) -> OfflineRecognizer:
    """Create the official Japanese K2-v2 int8 transducer through sherpa-onnx."""
...
def transcribe_reazonspeech(
    ...
    """Transcribe one mono 16 kHz segment using ReazonSpeech's padding contract."""
